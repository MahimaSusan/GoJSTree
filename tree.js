 function init() {
   ...
   model.nodeDataArray = [
     ...
     { "key": 15, text: "Santo Philip", parent: 14, level: "5", color: "#546336", description: "" },
     { "key": 16, text: "Ajeem Ashraf", parent: 14, level: "5", color: "#546336", description: "" },
     { "key": 17, text: "Deena Philip", parent: 14, level: "5", color: "#546336", description: "" },
     { "key": 18, text: "Akshaya Thazhathu", parent: 14, level: "5", color: "#546336", description: "" },
     { "key": 19, text: "Jayashankar Babu", parent: 14, level: "5", color: "#546336", description: "" },
     { "key": 20, text: "UX Designer", parent: 3, level: "4", color: "#668547", description: "designing the UX as per the requirements" },
     { "key": 21, text: "Nandu Sreekumar", parent: 20, level: "5", color: "#5C8547", description: "" },
     { "key": 22, text: "Designer", parent: 3, level: "4", color: "#47857A", description: "designing the UI as per the requirements" },
     { "key": 23, text: "Anoop Krishna", parent: 22, level: "5", color: '#366363', description: "" },
     ...
     { "key": 25, text: "Shaira Nooh", parent: 24, level: "5", color: "#363D63", description: "" },
     { "key": 26, text: "Project Managers", parent: 4, level: "4", color: "#BF5540", description: "Manages the whole Project flow" },
     { "key": 27, text: "Vibhin Sreevalsan", parent: 26, level: "5", color: "#BF6A40", description: "" },
     { "key": 28, text: "Saju Devasia", parent: 26, level: "5", color: "#BF6A40", description: "" },
     { "key": 29, text: "Business Analyst", parent: 4, level: "4", color: "#8F663D", description: "Analysing the project requirements" },
     { "key": 30, text: "Rohith Gabriel", parent: 29, level: "5", color: "#B2904D", description: "" },
     { "key": 31, text: "Architect", parent: 4, level: "4", color: "#85475C", description: "" },
     { "key": 32, text: "Lekshmi Krishnan", parent: 31, level: "5", color: "#854752", description: "" },
     { "key": 33, text: "Team Lead", parent: 4, level: "4", color: "#857A47", description: "Leads the whole project team" },
     { "key": 34, text: "Abhilash Vijayan", parent: 33, level: "5", color: "#636336", description: "" },
     { "key": 35, text: "Module Lead", parent: 4, level: "4", color: "#7A4785", description: "" },
     { "key": 36, text: "Nithal Ajayakumar", parent: 35, level: "5", color: "#633663", description: "" },
     ...
     { "key": 38, text: "Nimmi Sasidharan", parent: 37, level: "5", color: "#546336", description: "" },
     { "key": 39, text: "Sreya Paul", parent: 37, level: "5", color: "#546336", description: "" },
     { "key": 40, text: "Seena James", parent: 37, level: "5", color: "#546336", description: "" },
     { "key": 41, text: "UX Designer", parent: 4, level: "4", color: "#668547", description: "designing the UX as per the requirements" },
     { "key": 42, text: "Afthab Ali", parent: 41, level: "5", color: "#5C8547", description: "" },
     ...
     { "key": 44, text: "Anuja Murukesh", parent: 43, level: "5", color: "#363D63", description: "" }
   ];
