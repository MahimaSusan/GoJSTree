 function init() {
   ...
   model.nodeDataArray = [
     { "key": 1, "text": "QBurst", "level": "1", color: "#990000", description: "QBurst is a global IT services company focusing on Big Data Analytics, Cloud and DevOps Consulting, and Mobile App Development." },
     ...
     { "key": 6, "text": "Manooja Manoharan", "parent": 5, "level": "5", color: "#BF6A40" },
     { "key": 7, "text": "Saju Devasia", "parent": 5, "level": "5", color: "#BF6A40" },
     { "key": 8, "text": "Business Analyst", "parent": 3, "level": "4", color: "#8F663D", description: "Analysing the project requirements" },
     { "key": 9, "text": "Rohith Ramesh", "parent": 8, "level": "5", color: "#B2904D" },
     { "key": 10, "text": "Team Lead", "parent": 3, "level": "4", color: "#857A47", description: "Leads the whole project team" },
     { "key": 11, "text": "Al-Muneef Saifudeen", "parent": 10, "level": "5", color: "#636336" },
     { "key": 12, "text": "Sajeer Noohukannu", "parent": 10, "level": "5", color: "#636336" },
     { "key": 13, "text": "Manu Mohan", "parent": 10, "level": "5", color: "#636336" },
     ...
     { "key": 15, "text": "Santo Philip", "parent": 14, "level": "5", color: "#546336" },
     { "key": 16, "text": "Ajeem Ashraf", "parent": 14, "level": "5", color: "#546336" },
     { "key": 17, "text": "Deena Philip", "parent": 14, "level": "5", color: "#546336" },
     { "key": 18, "text": "Akshaya Thazhathu", "parent": 14, "level": "5", color: "#546336" },
     { "key": 19, "text": "Jayashankar Babu", "parent": 14, "level": "5", color: "#546336" },
     { "key": 20, "text": "UX Designer", "parent": 3, "level": "4", color: "#668547", description: "designing the UX as per the requirements" },
     { "key": 21, "text": "Nandu Sreekumar", "parent": 20, "level": "5", color: "#5C8547" },
     { "key": 22, "text": "Designer", "parent": 3, "level": "4", color: "#47857A", description: "designing the UI as per the requirements" },
     { "key": 23, "text": "Anoop Krishna", "parent": 22, "level": "5", color: '#366363' },
     ...
     { "key": 25, "text": "Shaira Nooh", "parent": 24, "level": "5", color: "#363D63" },
     { "key": 26, "text": "Project Managers", "parent": 4, level: "4", color: "#BF5540", description: "Manages the whole Project flow" },
     { "key": 27, "text": "Vibhin Sreevalsan", "parent": 26, level: "5", color: "#BF6A40" },
     { "key": 28, "text": "Saju Devasia", "parent": 26, level: "5", color: "#BF6A40" },
     { "key": 29, "text": "Business Analyst", "parent": 4, "level": "4", color: "#8F663D", description: "Analysing the project requirements" },
     { "key": 30, "text": "Rohith Gabriel", "parent": 29, "level": "5", color: "#B2904D" },
     { "key": 31, "text": "Architect", "parent": 4, "level": "4", color: "#85475C" },
     { "key": 32, "text": "Lekshmi Krishnan", "parent": 31, "level": "5", color: "#854752" },
     { "key": 33, "text": "Team Lead", "parent": 4, "level": "4", color: "#857A47", description: "Leads the whole project team" },
     { "key": 34, "text": "Abhilash Vijayan", "parent": 33, "level": "5", color: "#636336" },
     { "key": 35, "text": "Module Lead", "parent": 4, "level": "4", color: "#7A4785" },
     { "key": 36, "text": "Nithal Ajayakumar", "parent": 35, "level": "5", color: "#633663" },
     ...
     { "key": 38, "text": "Nimmi Sasidharan", "parent": 37, "level": "5", color: "#546336" },
     { "key": 39, "text": "Sreya Paul", "parent": 37, "level": "5", color: "#546336" },
     { "key": 40, "text": "Seena James", "parent": 37, "level": "5", color: "#546336" },
     { "key": 41, "text": "UX Designer", "parent": 4, "level": "4", color: "#668547", description: "designing the UX as per the requirements" },
     { "key": 42, "text": "Afthab Ali", "parent": 41, "level": "5", color: "#5C8547" },
     ...
     { "key": 44, "text": "Anuja Murukesh", "parent": 43, "level": "5", color: "#363D63" }
   ];
